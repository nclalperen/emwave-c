...
tatic void build_side_buttons(int panel_x, int panel_y, int panel_w, int panel_h,
                               int *pPaused, int *pAuto, int *pHold,
                               int *pCpml, int *pPorts, int *pPaint)
{
    ui_btn_count = 0;
    ...
    ADD_TOGGLE("pause",      (int*)&paused);        /* these pointers are only used for visual ON state */
