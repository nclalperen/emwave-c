...
**Effort:** 20 hours total | 3 Work Items | 43 test cases  
...
| Work Item | Feature | Effort | Priority | Test Cases | Status |
|--------|---------|--------|----------|------------|--------|
...
Notes:
- All three Work Items assume the Phase 2.75A-C navigation, grid, and measurement baselines are present.
- Work Items live in `Work Items/WORK_ITEM_37_Multi_Viewport_Split.md`, `Work Items/WORK_ITEM_38_Animation_Recording.md`, `Work Items/WORK_ITEM_39_Advanced_Measurement_Tools.md`.
...
- Week 1: Work Item #37 (layouts, per-viewport transforms, hotkeys)
- Week 2: Work Item #38 (recording) then #39 (measurements)
- Pros: Simplest integration/testing path; each Work Item stabilizes before adding the next.

**Option B: Parallel (Advanced)**
- Developer 1: Work Item #37
- Developer 2: Work Items #38 and #39
- Pros: Faster calendar time; requires early API alignment on AppState additions and rendering hooks.

**Option C: Essential Only**
- Implement Work Item #37 only (8h)
...
1) Read the Work Item document fully (objective, structures, sample code).  
2) Align AppState changes across Work Items before coding.  
3) Implement and unit-check each sub-section in the Work Item.  
...
- New lightweight helpers for CSV export (Work Item #39) if not already present
...
1. Work Item #37 cases (single -> quad, hover activation, sync toggles, perf smoke test).  
2. Work Item #38 cases (record at 30 fps, MP4 with/without FFmpeg, GIF size under 50 MB, PNG sequence paths).  
3. Work Item #39 cases (shoelace correctness on rectangle/triangle, annotation color/size, CSV import in Excel/LibreOffice).  

---

## Success Criteria (Per Work Item)

**Work Item #37: Multi-Viewport Split**
...
**Work Item #38: Animation Recording**
...
- [ ] Work Item #37 complete (16/16 tests)  
- [ ] Work Item #38 complete (12/12 tests)  
- [ ] Work Item #39 complete (15/15 tests)  
...
- Work Items #37-39 understood and AppState diffs reconciled.  
